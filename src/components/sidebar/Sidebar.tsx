...
const TicketsNav: React.FC<{ onNavigate?: () => void }> = ({ onNavigate }) => {
  ...
  return (
    <div className="flex flex-col">
      ...
      >
        {[
          { to: "/tickets", label: "Todos" },
          { to: "/tickets/comercial", label: "Comercial y Marketing" },
          { to: "/tickets/contabilidad", label: "Contabilidad" },
          { to: "/tickets/gerencia", label: "Gerencia" },
          { to: "/tickets/rrhh", label: "Recursos Humanos" },
          { to: "/tickets/otros", label: "Entre otros" },
        ].map((x) => (
          <NavLink
            key={x.to}
            to={x.to}
